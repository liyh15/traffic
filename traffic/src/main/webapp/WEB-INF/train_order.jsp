		...
		<div id="main">
			...
			<div class="personinformation">
				...
				<c:forEach items="${passengers}" var="pass" varStatus="tt">
				   <div class="information">
					<span class="ck" style="margin-left: 20px; width: 20px">${pass.name}</span><span class="pz1" style="margin-left: 47px;">成人票</span>
					<span class="zjlx1" style="margin-left: 39px;">${pass.type}</span><span class="zjhm1" style="margin-left: 62px;">${pass.personalId}</span>
					<span class="zw1" style="margin-left: 19px;"><%=explain[count++].split(",")[0]%></span><span class="bx1" style="margin-left: 29px;">途乐火车意外伤害险</span>
					<span class="bbr1" style="margin-left: 12px;">${pass.name}</span><span class="bdh1"></span>
				</div>
				</c:forEach>				
			</div>
			<div class="ddinformation">
				...
				<div class="fkinformation">
					<span style="margin-left: 20px;">${order.id}</span><span style="margin-left: 21px;">${order.createTime}</span>
					<span style="margin-left: 15px;">自取票</span><span style="margin-left: 45px;">￥<%=order.getTotlePrice()[0].split(":")[1]%></span>
					<span style="margin-left: 38px;">1x￥10</span><span style="margin-left: 20px;">￥0x1</span>
					<span style="margin-left: 96px;">￥0</span><span class="money1">￥<%=order.getTotlePrice()[0].split(":")[1]%></span>
					<span class="youhui">￥0</span><span class="money2">￥<%=order.getTotlePrice()[0].split(":")[1]%></span><span class="money3">-</span>
				</div>
			</div>
			<div class="phone">
